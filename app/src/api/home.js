...
const servicesMock = [
    { icon: 'brain', image: '', zh: '人工智能', en: 'AI Solutions', desc: '大模型应用、智能体开发、NLP 与计算机视觉 —— 为企业注入 AI 能力' },
    { icon: 'code', image: '', zh: '软件开发', en: 'Software Dev', desc: 'Web / 移动端 / 后端系统全栈开发，从原型到上线的完整交付' },
    { icon: 'cpu', image: '', zh: '物联网', en: 'IoT', desc: '设备接入、边缘计算、数据中台 —— 连接物理世界与数字世界' },
    { icon: 'globe', image: '', zh: '数字转型', en: 'Digital Transformation', desc: '技术咨询、架构设计、系统集成，助力企业完成数字化升级' },
];
