...
const newsMock = [
    { id: 1, date: '2026.05', title: 'Miwa AI Agent 框架获信通院认证', image: '/images/1.jpg', excerpt: '成为首批获得该认证的民营企业之一，已在金融、制造、零售三大行业落地超过 50 个场景。', content: 'Miwa 自主研发的企业级 AI Agent 开发框架 v2.0 正式通过中国信通院认证，成为首批获得该认证的民营企业之一。\n\n该框架聚焦企业级 AI 应用的核心痛点，提供多智能体协作、工具链可视化编排、安全审计等关键能力。在金融领域，某股份制银行基于该框架构建了智能风控助手，将信贷审批效率提升 60%；在制造业，某头部车企将其用于产线质量异常检测，误报率降至 0.3% 以下；在零售行业，某连锁品牌将其部署为门店运营助手，覆盖全国 3000+ 门店的日常管理。\n\n信通院专家组评价该框架"在架构设计、安全合规和工程化落地方面达到了行业领先水平"。' },
    { id: 2, date: '2026.04', title: 'Miwa 发布企业级 AI Agent 开发框架 v2.0', image: '/images/1.jpg', excerpt: '多智能体协作、工具链可视化编排、企业级安全审计，开发效率提升 3 倍。', content: 'Miwa 正式发布企业级 AI Agent 开发框架 v2.0，这是自 2024 年 v1.0 发布以来最重要的一次大版本升级。\n\nv2.0 的核心升级包括：多智能体协作引擎，支持 10+ Agent 并行协同工作；拖拽式工具链编排器，将 Agent 开发从纯代码转变为可视化配置；企业级安全审计模块，完整记录每一次 AI 决策链路，满足金融、医疗等强监管行业需求。\n\n"我们观察到企业在 AI 落地过程中最大的障碍不是模型能力，而是工程化。"Miwa CTO 在发布会上表示，"v2.0 的目标就是让 AI Agent 从实验室走进生产环境，像部署普通微服务一样简单。"' },
    { id: 3, date: '2026.02', title: '与华为联合打造工业 IoT 边缘计算方案落地', image: '/images/2.jpg', excerpt: '在长三角某新能源汽车工厂投入运营，实现产线数据毫秒级响应与预测性维护。', content: 'Miwa 与华为云联合研发的工业 IoT 边缘计算方案在长三角某新能源汽车工厂正式投入运营。\n\n该方案采用"端-边-云"三级架构：端侧部署轻量级数据采集 Agent，边侧运行 Miwa 自研的实时推理引擎，云端负责模型训练与全局调度。整套系统接入产线设备超过 3000 台，数据采集频率达到毫秒级，边缘推理延迟低于 10ms。\n\n项目上线三个月以来，产线非计划停机减少 45%，设备综合效率（OEE）提升 12 个百分点。华为云工业 IoT 负责人表示："这次合作验证了 Miwa 在边缘智能领域的技术实力，我们计划将该方案推广到更多行业场景。"' },
    { id: 4, date: '2025.12', title: '智能客服平台日均调用量突破 5000 万次', image: '/images/3.jpg', excerpt: '双十一期间准确率保持 97.8% 以上，人工转接率降低 60%。', content: '基于自研 NLP 引擎的智能客服平台在双十一期间创下新纪录——日均处理对话量突破 5000 万次，峰值 QPS 达到 12 万，意图识别准确率稳定在 97.8% 以上。\n\n该平台支持文本、语音、图像多模态交互，覆盖 30+ 语种，已为超过 200 家企业提供智能客服能力。核心技术包括基于 Transformer 的意图识别模型、多轮对话状态追踪、以及知识图谱增强的问答系统。\n\n"5000 万次不仅仅是一个数字，"Miwa 产品负责人表示，"每次对话背后都是一个真实的用户需求，我们帮助客户在保证服务质量的同时，将人工客服转接率降低了 60%。"' },
    { id: 5, date: '2025.10', title: '获得 ISO 27001 信息安全认证', image: '/images/4.jpg', excerpt: '标志着公司在数据安全与隐私保护方面达到国际标准。', content: 'Miwa 正式通过 ISO 27001 信息安全管理体系认证，该认证由国际权威认证机构 SGS 颁发。\n\nISO 27001 是全球最广泛认可的信息安全管理标准，涵盖 14 个控制域、114 项控制措施。Miwa 的认证范围包括 AI 平台研发、SaaS 服务运维、以及客户数据管理三大核心业务领域。\n\n"安全是 AI 服务的底线，"Miwa 安全负责人表示，"获得 ISO 27001 认证不是终点，而是我们持续投入安全建设的节点。下一步我们将推进 SOC 2 Type II 认证，进一步向国际客户证明我们的安全保障能力。"' },
    { id: 6, date: '2025.08', title: '与蔚来达成战略合作，共建车载 AI 实验室', image: '/images/5.jpg', excerpt: '在智能座舱、自动驾驶数据标注、车联网安全三个方向展开深度合作。', content: 'Miwa 与蔚来汽车签署战略合作协议，双方将在上海张江联合建立车载 AI 实验室。\n\n合作聚焦三大方向：智能座舱方面，基于 Miwa 的 NLP 和多模态技术打造下一代车载语音助手；自动驾驶数据标注方面，利用 Miwa 的自动标注平台将标注效率提升 5 倍以上；车联网安全方面，联合研发车辆异常行为检测系统。\n\n蔚来 CTO 表示："Miwa 在 AI 应用工程化方面的经验与我们「技术驱动用户体验」的理念高度契合。我们期待通过深度合作，将最前沿的 AI 能力带入每一辆蔚来汽车。"联合实验室初期团队规模约 50 人，计划在未来两年内扩展至 200 人。' },
    { id: 7, date: '2025.07', title: '发布开源 IoT 中间件 MiwaLink v1.0', image: '/images/1.jpg', excerpt: '轻量级高性能 IoT 设备连接中间件，GitHub 已获 2.3k stars。', content: 'Miwa 正式开源 IoT 中间件 MiwaLink v1.0，采用 Apache 2.0 许可证。\n\nMiwaLink 是一款专为 IoT 场景设计的轻量级设备连接中间件，核心特性包括：支持 MQTT 5.0、CoAP、HTTP/3 多协议自适应接入；单节点支持 100 万并发设备连接；内置规则引擎，支持低代码数据流编排；边缘网关模式，断网时可离线运行。\n\n发布首月在 GitHub 获得 2.3k stars，社区贡献者超过 30 人。目前已有多家智能制造企业基于 MiwaLink 构建了设备管理平台。"开源是我们回馈技术社区的方式，"Miwa 开源负责人表示，"IoT 领域缺乏好的中间件，我们希望 MiwaLink 能填补这个空白。"' },
    { id: 8, date: '2025.05', title: '完成 A 轮融资，加速国际化布局', image: '/images/2.jpg', excerpt: '红杉中国领投，用于扩充核心研发团队、拓展东南亚及欧洲市场。', content: 'Miwa 宣布完成 A 轮融资，由红杉中国领投，上一轮投资方跟投。融资金额未披露，将主要用于三个方向：\n\n一是扩充核心研发团队，计划在一年内将上海研发中心从 80 人扩展至 200 人，重点招募 AI 算法、分布式系统、安全领域的资深工程师；二是拓展东南亚及欧洲市场，已启动新加坡办公室的筹建工作，预计 2026 年 Q1 投入运营；三是加大 AI 基础能力投入，包括自研模型训练基础设施和开源生态建设。\n\n红杉中国合伙人表示："我们看好 Miwa 在 AI 应用工程化领域的独特定位。他们不追逐模型参数竞赛，而是专注将 AI 真正落地到产业场景中，这是一种更务实的商业路径。"' },
];
