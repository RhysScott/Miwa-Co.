...
// 模拟 API 接口
export async function fetchServices() { await delay(); return services; }
export async function fetchProjects() { await delay(); return projects; }
export async function fetchClients() { await delay(); return clients; }
export async function fetchStats() { await delay(); return stats; }
export async function fetchNews() { await delay(); return news; }
export async function fetchProcess() { await delay(); return processSteps; }
export async function fetchHomeData() {
    await delay(300);
    return { services, projects, clients, stats, news, process: processSteps };
}
